...
public class HeapsortTest {
	...
	public void heapsortTest(int[] in, int[] expected, String description) {
		Heapsort.heapsort(in);
		log.debug("\n\n{}\n\n", debug(in));
	...
	public Object[][] data() {
		...
		return new Object[][] {
				{ new int[] { 1 }, new int[] { 1 }, "len 1 array" },
				{ new int[] { 2, 1 }, new int[] { 1, 2 },
						"len 2 unsorted array" },
				{ new int[] { 20, 1 }, new int[] { 1, 20 },
						"len 2 unsorted non-consecutive array" },
				{ new int[] { 1, 2 }, new int[] { 1, 2 }, "len 2 sorted array" },
				{ new int[] { 1, 2, 3, 4, 5, 6, 7, 8 }, evenSorted,
						"len 8 sorted array" },
				{ new int[] { 8, 7, 6, 5, 4, 3, 2, 1 }, evenSorted,
						"len 8 reverse sorted array" },
				{ new int[] { 7, 4, 1, 5, 8, 2, 3, 6 }, evenSorted,
						"len 8 unsorted array" },
				{ new int[] { 7, 4, 1, 9, 5, 8, 2, 3, 6 }, oddSorted,
						"odd len 9 unsorted array" },
				{ new int[] { 1, 1, 1, 1, 1, 1, 1, 1 },
						new int[] { 1, 1, 1, 1, 1, 1, 1, 1 },
						"len 8 all equal elements array" },
				{ new int[] { 4, 3, 2, 1, 1, 3, 2, 4 },
						new int[] { 1, 1, 2, 2, 3, 3, 4, 4 },
						"len 8 array with duplicate elements" },
